  ...
  buildSidebar() {
    ...
    document.getElementById('sidebar').innerHTML = `
      ...
      <div class="sidebar-footer">
        ...
        <a href="https://bagasaria93.github.io" target="_blank" rel="noopener noreferrer" style="font-size:10px;color:rgba(255,255,255,0.55);text-decoration:none;display:block;text-align:center;padding:8px 0 4px;">by Bagas Aria Sativa</a>
      </div>`;
